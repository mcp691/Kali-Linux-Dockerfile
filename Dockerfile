...
RUN apt -y install curl wget vim git net-tools whois netcat-traditional pciutils usbutils dnsutils nfs-common telnet snmp ftp jq iputils-ping pipx
...
RUN DEBIAN_FRONTEND=noninteractive apt -y install kali-tools-top10 exploitdb man-db apktool dex2jar ltrace strace binwalk evil-winrm crackmapexec
